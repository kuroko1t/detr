...
def build(dataset_file, hidden_dim, position_embedding,
          lr_backbone, masks, backbone, dilation,
          num_classes, num_queries, device, dropout, nheads,
          dim_feedforward, enc_layers, dec_layers, pre_norm, aux_loss,
    ...
    backbone = build_backbone(hidden_dim, position_embedding,
                              lr_backbone, masks, backbone, dilation)
    ...
    matcher = HungarianMatcher(cost_class=set_cost_class,
                               ...
                               cost_giou=set_cost_giou)#build_matcher(args)
